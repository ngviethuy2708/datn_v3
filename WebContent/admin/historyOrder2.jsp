		...
		<div class="row">
			...
			<div class="col-md-12 main">
		    		...
		    		<div class="col-md-10">
		    			<form class="form-inline" role="form" action="<%=request.getContextPath()%>/admin/searchOrder" method="post">
  							<div class="form-group" style="margin-left:635px;">
    							<input name="nameProduct" type="text" class="form-control" id="exampleInputPassword2" placeholder="keyword">
  							</div>
				...
				<div class="pagi">
					...
					%>
  						<li <%=active %>><a href="<%=request.getContextPath() %>/admin/historyOrder2?page=<%=i%>"><%=i %></a></li>
  					<%} %>
					</ul>
				</div>
			</div>
