            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="page-caption">
                        <h2 class="page-title"><%=objEx.getName() %></h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="page-breadcrumb">
        <div class="container">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active"><%=objEx.getName() %></li>
                </ol>
            </div>
        </div>
    </div>
                 ...
                 <h1><%=objEx.getName()%></h1>
                 		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                       			<img style="width:230px; height:200px;" src="<%=request.getContextPath() %>/files/<%=objEx.getImage()%>">
                       		</div>
                       		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                       			 <p class="lead"><%=objEx.getPreview() %> </p>
                       		</div>
                       	</div>
                     
                        <p><%=objEx.getDeatail() %></p>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/<%=objEx.getVideo() %>" frameborder="0" allowfullscreen></iframe>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  	<!-- widget start -->
