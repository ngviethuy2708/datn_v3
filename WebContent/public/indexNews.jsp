        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                    <div class="row">
                    <%
                    ArrayList<Post> alNews = (ArrayList<Post>)request.getAttribute("alNews");
                    for(Post objNews : alNews){
                    %>
                        <div class="col-lg-11 col-sm-11 col-md-11 col-sm-11">
                            <div class="post-holder">
                                ...
                                <div class="post-img">
                                    <!-- post img -->
                                    <a target="_blank" href="<%=request.getContextPath()%>/detailNews?id=<%=objNews.getId()%>"><img style="width:750px; height:335px;" src="<%=request.getContextPath() %>/files/<%=objNews.getImage() %>" alt="" class="img-responsive"></a>
                                ...
                                <div class="post-content">
                                    ...
                                    <div class="post-header">
                                        <!-- post header -->
                                        <h1 class="post-title"><a href="blog-single.html" class="title"><%=objNews.getName() %></a></h1>
                                    </div>
                                    <!-- /.post header -->
                                     <div class="post-header">
                                        <!-- post header -->
                                        <div class="meta">
                                            ...
                                            <span class="meta-cat"> Tin tức-sự kiện</span>
                                        </div>
                                        <!-- /.post meta -->
                                    	
                                    </div>
                                    <p><%=objNews.getPreview() %></p>
                                    <a href="<%=request.getContextPath()%>/detailIntroduce?id=<%=objNews.getId()%>" class="btn btn-default">Chi tiết</a>
                                </div>
                                <!-- /.post content -->
                            </div>
                            <!-- /.post holder -->
