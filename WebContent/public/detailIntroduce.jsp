<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="page-header">
        <div class="container">
        <%
        Post objIntro = (Post)request.getAttribute("objIntro");
        %>
        
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="page-caption">
                        <h2 class="page-title"><%=objIntro.getName() %></h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                 <h1><%=objIntro.getName()%></h1>
                 		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                 				
                       			<img style="width:200px; height:200px;" src="<%=request.getContextPath() %>/files/<%=objIntro.getImage()%>">
                       			
                       		</div>
                       		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                       			 <p class="lead"><%=objIntro.getPreview() %> </p>
                       			
                       		</div>
                       	</div>
                     
                        <p><%=objIntro.getDetail() %></p>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  	  <!-- widget start -->
